...
from .datasets import IuxrayMultiImageDataset, MimiccxrSingleImageDataset, LGKNoLabelDataset
    ...
    def __init__(self, args, tokenizer, split, shuffle):
        ...
        if split == 'train':
            self.transform = transforms.Compose([
                ...
                transforms.RandomAffine(degrees=0, translate=(0.2, 0.2), scale=(0.8, 0.8), fill=(0, 0, 0)),
                transforms.ToTensor(),
                normalize])
        else:
            self.transform = transforms.Compose([
        ...
        elif self.dataset_name == 'LGK':
            self.dataset = LGKNoLabelDataset(self.args, self.tokenizer, self.split, transform=self.transform)
        else:
